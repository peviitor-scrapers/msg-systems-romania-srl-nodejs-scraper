...
```bash
gh issue list --repo peviitor-scrapers/msg-systems-romania-srl-nodejs-scraper --state open
```
...
- `docs/test-results/index.html` — branding must say "MSG Systems", not "EPAM"
