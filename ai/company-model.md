...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "MSG Systems") |
| group        | string   | Parent company group (e.g. "MSG Group") |
...
- **scraperFile**: Full URL to the GitHub Actions workflow (no raw, e.g. `https://github.com/peviitor-scrapers/msg-systems-romania-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml`)
